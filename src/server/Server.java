...
public class Server {
    ...
    public static void main(String[] args) {
        try {
            InetAddress inetAddress = InetAddress.getByName("25.65.94.55"); // Escucha en todas las interfaces de red
            try (ServerSocket serverSocket = new ServerSocket(PORT, 50, inetAddress)) {
                ...
                SwingUtilities.invokeLater(() -> new InterServer().setVisible(true));
    ...
    System.out.println("Request recibido: " + request);  // Log request
    ...
    switch (command) {
        case "LOAD":
            System.out.println("Comando LOAD recibido para tipo de archivo: " + fileType);  // Log command
